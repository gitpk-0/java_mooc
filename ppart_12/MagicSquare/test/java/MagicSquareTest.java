...
public class MagicSquareTest {
    ...
    public void sumsOfColumnsIsCorrect() {
        ...
        assertTrue("When the magic square is:\n" + ms + "\nThe list returned by the sumsOfColumns method should contain the values  4 ja 6. Now this was not the case. 4", sumsOfColumns.contains(4));
        assertTrue("When the magic square is:\n" + ms + "\nThe list returned by the sumsOfColumns method should contain the values  4 ja 6. Now this was not the case. 6", sumsOfColumns.contains(6));
    }
